...
function SalaryDetailsDeductions({ 
  ...
  setTotalDeductionTitle }) {
    ...
    const[errors,setErrors]=useState({})
      ...
      // Delete Function
      const deleteRow= (id)=> setDeductionList(deductionList.filter((row)=> row.id!==id))
      ...
      <thead className='bg-gray-200'>
          ...
          <tr>
            ...
            <td className='font-bold'>
                ...
                />
                {errors.deductionHeaderAmount && <p className='error'>{errors.deductionHeaderAmount}</p>}
            ...
            <td className='font-bold'>
                ...
                onKeyDown={(e)=>handleEmpIdKeyDown(e,'deductionHeaderAmount')}
                style={{marginLeft:'17px'}}
                />
                 {errors.deductionHeaderAmount && <p className='error'>{errors.deductionHeaderAmount}</p>}
            </td>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              />
              {errors.deductionTitle && <p className='error'>{errors.deductionTitle}</p>}
            </td>
            ...
            <td>
              <input
                ...
                onFocus={(e)=>handleSubmit(e)}
                />
              {errors.deductionAmount && <p className='error'>{errors.deductionAmount}</p>}
            </td>
            <td></td>
          </tr>
        </tbody>
    ...
    <table width="100%">
      ...
      {deductionList.map(({id,deductionTitle,deductionAmount})=>(
         ...
         <React.Fragment key={id}>
          ...
          <tbody>
          <tr>
              <td><span style={{marginLeft:'17px'}}>{deductionTitle}</span></td>
              <td className='deductionAmount1'>{deductionAmount}</td>
              <td><button className='text-red-400 text-xl' onClick={()=>deleteRow(id)}><AiOutlineDelete /></button></td>
          </tr>
          </tbody>
         </React.Fragment>
